...
import org.nahap.bookcatalogservice.dto.request.LoginRequest;
import org.nahap.bookcatalogservice.dto.response.AuthResponse;
import org.nahap.bookcatalogservice.security.CustomUserDetails;
...
public class AuthController {
    ...
    public ResponseEntity<AuthResponse> login(
        ...
        String jwtToken = jwtUtil.generateToken(userDetails, userDetails.getId());
